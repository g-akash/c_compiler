...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<declnode*>
    {
        static Tag__ const tag = Tag__::decl1;
    };
    ...
    {
        static Tag__ const tag = Tag__::abs;
    };
    ...
    template <>
    struct TypeOf<Tag__::decl1>
    {
        typedef declnode* type;
    };
